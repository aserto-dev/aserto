...
require (
	...
	github.com/aserto-dev/topaz v0.32.34
...
require (
	...
	github.com/aserto-dev/aserto-management v0.9.7 // indirect
	github.com/aserto-dev/azm v0.1.19 // indirect
	github.com/aserto-dev/certs v0.0.7 // indirect
	github.com/aserto-dev/errors v0.0.11 // indirect
	github.com/aserto-dev/go-authorizer v0.20.11 // indirect
	github.com/aserto-dev/go-directory v0.31.14 // indirect
	github.com/aserto-dev/go-edge-ds v0.32.12 // indirect
	...
	github.com/aserto-dev/self-decision-logger v0.0.8 // indirect
	github.com/aserto-dev/service-host v0.0.17 // indirect
