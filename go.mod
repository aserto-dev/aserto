...
require (
	...
	github.com/aserto-dev/aserto-tenant v0.1.65
	github.com/aserto-dev/go-grpc v0.0.24
	github.com/aserto-dev/go-grpc-authz v0.0.2
	github.com/aserto-dev/go-lib v0.5.21
...
require (
	...
	github.com/aserto-dev/aserto-idp-plugin-okta v0.0.5 // indirect
	github.com/aserto-dev/go-grpc-clients v0.1.4 // indirect
	github.com/aserto-dev/go-grpc-internal v0.0.8 // indirect
